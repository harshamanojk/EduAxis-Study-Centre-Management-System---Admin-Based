...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['action'] == 'delete') {
  ...
  $servername = "localhost"; 
    $username = "root"; 
    $password = "hmk12345#Tia"; // Change this to your database password
    $dbname = "eduaxis"; 
    ...
    try {
        ...
        // SQL to delete adminuser
        $stmt = $pdo->prepare("DELETE FROM admin_user WHERE email = :email");
        ...
        if ($stmt->rowCount() > 0) {
            ...
            header('Location: WELCOME PAGE.php'); // Redirect to login page
            exit;
        } else {
