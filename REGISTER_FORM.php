...
$username     = "root";
$password_db  = "hmk12345#Tia"; // Change this to your database password
$dbname       = "eduaxis";
...
$errorname = $erroremail = $errorpassword = $errorcontact = "";
$notification = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($_POST["txtemail"])) {
        ...
        } elseif (!preg_match("/@eduaxis\.com$/", $email)) {
            $erroremail = " This ID is not valid. Use your eduaxis.com email.";
        }
    }
    ...
    if ($errorname == "" && $erroremail == "" && $errorpassword == "" && $errorcontact == "") {
        ...
        $checkStmt = $conn->prepare("SELECT id FROM admin_user WHERE email = ?");
        ...
        if ($checkStmt->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO admin_user (name, email, password, contact) VALUES (?, ?, ?, ?)");
...
<head>
    ...
    <title>ADMIN REGISTER | EduAxis</title>
    <!-- Bootstrap CSS -->
...
<div class="container">
    <div class="form-container">
        ...
        <h2 class="text-center"><u><b>EDUAXIS ADMIN</b></u></h2>
        ...
        <form method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>">
            <div class="form-group">
                <input type="text" class="form-control" id="name" name="txtname"
                       placeholder="Full Name" value="<?= htmlspecialchars($name) ?>">
            ...
            <div class="form-group">
                <input type="tel" class="form-control" id="contact" name="txtcontact"
                       placeholder="Contact Number" value="<?= htmlspecialchars($contact) ?>">
